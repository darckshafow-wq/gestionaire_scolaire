                    ...
                    <div style="flex: 1;">
                        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 1.5rem;">
                            <div>
                                ...
                                <?php if (!isset($etudiant['statut']) || $etudiant['statut'] === 'Inscrit' || $etudiant['statut'] === ''): ?>
                            ...
                            <div style="display: flex; gap: 0.75rem;">
                                <a href="/modifier_etudiant?id=<?= $etudiant['id'] ?>" class="btn-light" style="padding: 0.5rem 1rem; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem; border-radius: 8px;">
